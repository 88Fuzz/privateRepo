...
import static com.murder.game.other.Constants.PPM;
...
//        fd.filter.maskBits = Constants.BIT_PLAYER | Constants.BIT_WALL | Constants.BIT_SENSOR;
    ...
    public static Body createBox(final World world, float x, float y, float w, float h, boolean isStatic, boolean canRotate, short cBits, short mBits,
            short gIndex)
    {
    ...
    public static Body createCircle(final World world, float x, float y, float r, boolean isStatic, boolean canRotate, short cBits, short mBits,
            short gIndex)
    {
        BodyDef bodyDef = new BodyDef();
        bodyDef.fixedRotation = canRotate;
